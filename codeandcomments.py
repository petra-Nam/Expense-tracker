...
# Define the file where user profiles will be stored
...
# Handle expenses file for the user identified by email
...
# Get category totals for a specific month and year
...
# Plot expenses by category for a specific month and year
